...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-user-edit me-2"></i>Edit Data Siswa</h1>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Edit Data Siswa: {{ $student->name }}</h5>
    </div>
    <div class="card-body">
        @if($errors->any())
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('entry_date') is-invalid @enderror" 
                               id="entry_date" name="entry_date" value="{{ old('entry_date', $student->entry_date ? $student->entry_date->format('Y-m-d') : '') }}" required>
                        @error('entry_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
